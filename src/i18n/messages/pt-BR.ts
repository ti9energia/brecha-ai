...
const messages = {
  ...
  owner: {
    ...
    systemIdentity: "Identidade da plataforma",
    systemName: "Nome da plataforma",
    systemSupportEmail: "E-mail de suporte",
    systemLocales: "Idiomas",
    systemDefaultLocale: "Idioma padrão",
    systemActiveLocales: "Idiomas ativos",
    systemSecurity: "Segurança",
    systemStrongPassword: "Senha forte obrigatória",
    systemStrongPasswordHint: "Exige ≥12 chars, maiúsc., número e símbolo.",
    systemMfa: "Multi-fator (MFA)",
    systemMfaHint: "Exige segundo fator ao fazer login.",
    systemMaintenance: "Modo de manutenção",
    systemMaintenanceHint: "Bloqueia logins de usuários não-admin.",
