...
export async function POST(req: Request) {
  const limited = rateLimit(req, "wa-optin", { max: 10, windowMs: 60_000 });
  ...
  sendWhatsapp(normalized, `Brecha.ai: seu código de verificação é ${code}. Responda com ele para vincular este número.`);
